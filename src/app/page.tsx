...
export default function Home () {
  ...
  const [selectedItems, setSelectedItems] = useState<Array<{
    categoryId: number;
    quantity: number;
    brandSelections: Record<number, number>; // brandId -> quantity
  }>>([]);
  ...
  // Calculate total modules for validation
  ...
  const handleCategoryChange = (itemIndex: number, categoryId: number | null) => {
    ...
    setSelectedItems(prev => {
      ...
      newItems[itemIndex] = {
        ...newItems[itemIndex],
        categoryId,
        brandSelections: {} // Reset brand selections when category changes
      };
      return newItems;
    });
  };
  ...
  // Handle brand selection for an item
    ...
    setTimeout(() => {
      ...
      brands.forEach(brand => {
        ...
        selectedItems.forEach(item => {
          ...
          // For each brand, get the quantity selected for this item
        ...
        const tax = (subtotal * 18) / 100; // 18% tax
  ...
  // Validation: Check if total modules fit within plate size
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex flex-col items-center">
          ...
          <h1 className="text-2xl font-bold text-center text-gray-900 dark:text-gray-100">
            Electrical Material Price Comparison
          </h1>
